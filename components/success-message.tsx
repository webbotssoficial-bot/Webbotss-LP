...
export default function SuccessMessage({ title, description }: SuccessMessageProps) {
  return (
    <Card className="w-full max-w-sm mx-auto p-6 min-h-[300px] flex flex-col justify-center border-primary/20 shadow-lg backdrop-blur-sm">
      <CardContent className="space-y-4 flex flex-col items-center justify-center">
        ...
        >
          <div className="relative">
            <motion.div
              className="absolute inset-0 blur-xl bg-primary/10 dark:bg-primary/20 rounded-full"
              initial={{ opacity: 0, scale: 0.8 }}
              animate={{ opacity: 1, scale: 1 }}
              transition={{
                delay: 0.2,
