      ...
      <div className="min-h-[calc(100vh-4rem)] bg-background flex items-center justify-center py-8">
        <div className="container max-w-md">
          <SuccessMessage
            ...
            description="Nossa equipe entrará em contato em breve para agendar uma conversa com um especialista."
          />
          ...
          <Card className="border-primary/20 shadow-lg">
            <CardHeader className="space-y-1 pb-6">
              <motion.div variants={itemVariants}>
                <CardTitle className="text-2xl font-bold">Fale com um Especialista</CardTitle>
                <CardDescription className="text-base">
                  Preencha o formulário abaixo para agendar uma conversa com um de nossos especialistas em automação.
                </CardDescription>
              </motion.div>
            </CardHeader>
            <CardContent>
